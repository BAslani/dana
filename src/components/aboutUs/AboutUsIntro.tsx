          ...
          <div className='mx-auto w-[280px] bg-gradient-to-bl from-transparent via-transparent to-[#507CF820] p-px backdrop-blur-md sm:w-[430px] md:w-[340px] md:self-end lg:w-[640px]'>
            <div className='flex size-full flex-col items-center gap-[10px] px-6 py-4 md:gap-6'>
              ...
              <p className='text-center text-body-S-2 text-gray-50 sm:text-body-M-2 md:text-justify md:text-body-L-2 lg:text-body-XL-2'>
                <span className='font-semibold'>Mission:</span> To deliver sustainable, scalable, secure, and efficient solutions for data infrastructure by leveraging cutting-edge technologies and innovative approaches to meet the growing needs of organizations and ensure optimal data center performance.

<br /> <span className='font-semibold'>Vision:</span> To become the most trusted and leading business partner in data center infrastructure across the Middle East, providing standardized, reliable, and knowledge-driven services that prioritize customer trust and continuous innovation.
              </p>
            </div>
          </div>
          <div className='mx-auto flex w-[280px] flex-col items-center gap-[10px] px-6 py-4 backdrop-blur-md sm:w-[430px] md:w-[340px] md:gap-6 md:self-start lg:w-[640px]'>
            ...
            <p className='text-justify text-body-S-2 text-gray-50 sm:text-body-M-2 md:text-body-L-2 lg:text-body-XL-2'>
              ...
              engineers, it offers innovative and adaptable solutions to meet project needs.
              By addressing industry gaps through thorough analysis, the company has
              built a robust platform combining IT, infrastructure,
              project management, and expertise to seize future opportunities.
            </p>
          </div>
        </div>
      </div>
